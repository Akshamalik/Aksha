...
export const infoList = [
    { icon: assets.code_icon, iconDark: assets.code_icon_dark, title: 'Full Stack Skills', description: 'HTML, CSS, JavaScript, React Js, Next Js, MongoDB, SQL, Django, TailwindCss, NodeJs' },
    { icon: assets.edu_icon, iconDark: assets.edu_icon_dark, title: 'Education', description: 'B.Tech in Computer Science' },
    { icon: assets.project_icon, iconDark: assets.project_icon_dark, title: 'Projects', description: 'Built multiple projects in full stack' }
];
